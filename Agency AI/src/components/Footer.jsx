...
const Footer = ({ theme }) => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="mt-20 bg-slate-50 px-4 pt-10 sm:mt-40 sm:px-10 sm:pt-10 lg:px-24 xl:px-40 dark:bg-gray-900"
    >
      {/* footer top */}
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="flex flex-wrap justify-center gap-4 pb-6 text-sm text-gray-500 sm:justify-between"
      >
